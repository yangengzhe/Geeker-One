<?php get_header(); ?>
<link href="<?php bloginfo('template_url');?>/single.css" rel="stylesheet">
<div id="content_wrap">
...
<p class="bg-warning" style="margin-top: 10px;">如未说明则本站原创，转载请注明出处：<a href="<?php bloginfo('url'); ?>"><?php bloginfo('name'); ?></a> » <a href="<?php the_permalink() ?>"><?php the_title(); ?></a></p>
